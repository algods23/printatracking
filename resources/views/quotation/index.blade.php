...
<div class="max-w-6xl mx-auto space-y-6">
    <form method="GET" action="{{ route('quotation.index') }}" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-5 flex flex-col md:flex-row gap-3 items-stretch md:items-end">
        <div class="flex-1">
            <label for="q" class="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Search customer</label>
            <input type="text" id="q" name="q" value="{{ request('q') }}" placeholder="Search by customer name, quotation ID, or phone..." class="w-full px-4 py-2.5 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 text-gray-900 dark:text-white">
        </div>
        <div class="flex gap-2">
            ...
            <a href="{{ route('quotation.index') }}" class="px-5 py-2.5 bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-white font-semibold rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">Clear</a>
            <a href="{{ route('quotation.download', request()->only('q')) }}" class="px-5 py-2.5 bg-green-700 hover:bg-green-600 text-white font-semibold rounded-lg transition-colors">Download File</a>
        </div>
    </form>
            ...
            <table class="w-full">
                <thead>
                    <tr class="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                        ...
                        <th class="px-6 py-3 text-left text-sm font-semibold text-gray-900 dark:text-gray-100">Quotation ID</th>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            ...
                            <td class="px-6 py-4 text-sm">
                                <div class="flex items-center gap-2">
                                    ...
                                    <a href="{{ route('quotation.download', ['q' => $task->customer_name]) }}" class="p-2 text-green-700 dark:text-green-400 hover:bg-green-500/10 rounded transition-colors inline-flex" title="Download customer quotation PDF">
                        ...
                        <tr>
                            <td colspan="8" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <p class="text-gray-500 dark:text-gray-400">No quotation data found</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
